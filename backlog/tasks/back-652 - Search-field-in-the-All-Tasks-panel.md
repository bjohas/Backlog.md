...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 A search input in the filter row narrows visible rows by ID or title substring, case-insensitive, as you type
- [ ] #2 The input works while maximized
- [ ] #3 The shown count reflects the narrowed rows and clearing the input restores the full list
<!-- AC:END -->
